var diva = create('div', 'container-fluid mt-5 ml-5 p-5');
...
input.disabled = true;
input.setAttribute('style', `line-height:60px; background-color:skyblue; font-family: 'Comfortaa', cursive;`);
input.id = "display";

var btnnum= createElements('button', 'btn-fluid btn-dark text-md-center text-sm-left text-xs-left p-md-3 p-sm-4 p-xs-4 col-2', 10);
btnnum[0].setAttribute('onclick', "appendNumber(0)");
btnnum[1].setAttribute('onclick', `appendNumber(1)`);
btnnum[2].setAttribute('onclick', `appendNumber(2)`);
btnnum[3].setAttribute('onclick', `appendNumber(3)`);
btnnum[4].setAttribute('onclick', `appendNumber(4)`);
btnnum[5].setAttribute('onclick', `appendNumber(5)`);
btnnum[6].setAttribute('onclick', `appendNumber(6)`);
btnnum[7].setAttribute('onclick', `appendNumber(7)`);
btnnum[8].setAttribute('onclick', `appendNumber(8)`);
btnnum[9].setAttribute('onclick', `appendNumber(9)`);
...
diva.append(divarr[0], divarr[1], divarr[2], divarr[3], divarr[4], divarr[5]);
divarr[0].append(input);
divarr[1].append(square, root, clear, division);
divarr[2].append(btnnum[7], btnnum[8], btnnum[9], mul);
divarr[3].append(btnnum[4], btnnum[5], btnnum[6], sub);
divarr[4].append(btnnum[1], btnnum[2], btnnum[3], add);
divarr[5].append(cube, btnnum[0], dot, equals);
